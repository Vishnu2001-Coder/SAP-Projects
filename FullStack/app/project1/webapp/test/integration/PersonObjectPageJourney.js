...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PersonObjectPageObjectPage journey");

        opaTest("Navigate to PersonObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheBooksObjectPage.onTable({ property: "Person" }).iCheckRows();
            When.onTheBooksObjectPage.onTable({ property: "Person" }).iPressRow(0);

            Then.onThePersonObjectPage.iSeeThisPage();
        });
