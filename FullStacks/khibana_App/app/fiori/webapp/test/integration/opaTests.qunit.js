...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "ns/fiori/test/integration/FirstJourney",
    "ns/fiori/test/integration/BooksListJourney",
    "ns/fiori/test/integration/BooksObjectPageJourney",
    "ns/fiori/test/integration/PersonObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
