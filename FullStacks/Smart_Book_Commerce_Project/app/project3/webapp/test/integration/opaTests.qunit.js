...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "ns/project3/test/integration/FirstJourney",
    "ns/project3/test/integration/CustomersListJourney",
    "ns/project3/test/integration/CustomersObjectPageJourney",
    "ns/project3/test/integration/ReviewsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
